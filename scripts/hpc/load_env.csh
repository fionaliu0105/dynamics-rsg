#!/usr/bin/env tcsh
# Single-command environment activation (tcsh/csh). Loads the module stack and
...
#
# Run scripts/hpc/setup_env.sh (bash) first if .venv doesn't exist yet.

setenv REPO_DIR /data/sld/homes/vguigon/dynamics-rsg

module use /software/sld/modulefiles
module load python/3.11.10
source $REPO_DIR/.venv/bin/activate.csh
